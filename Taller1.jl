...
md"""
# Taller 1: Transformaciones entre sistemas de coordenadas
"""
...
md"""
1. Convertir los siguientes puntos de coordenadas cartesianas a cilíndricas:
...
arrows2d!(ax, (0,0,0), (5,0,0), color = :red, lengthscale = 1.0)
arrows2d!(ax, (0,0,0), (0,5,0), color = :green, lengthscale = 1.0)
arrows2d!(ax, (0,0,0), (0,0,5), color = :blue, lengthscale = 1.0)
...
# Draw coordinate axes correctly
arrows2d!(ax2, (0,0,0), (5,0,0), color = :red, lengthscale = 1.0)
arrows2d!(ax2, (0,0,0), (0,5,0), color = :green, lengthscale = 1.0)
arrows2d!(ax2, (0,0,0), (0,0,5), color = :blue, lengthscale = 1.0)
...
manifest_format = "2.0"
project_hash = "586f5abc63e925fdc66612d856c609da2a70c378"
