...
arrows2d!(ax3, [0, 0], [0, 0], [r1[1], r2[1]], [r1[2], r2[2]], color=:green)

# Draw distance vector
arrows2d!(ax3, [r1[1]], [r1[2]], [R12[1]], [R12[2]], color=:black)
...
# Draw force vectors
arrows2d!(ax3, [r1[1]], [r1[2]], -[R12[1]]*0.25, -[R12[2]]*0.25, color=:red)

arrows2d!(ax3, [r2[1]], [r2[2]], [R12[1]]*0.25, [R12[2]]*0.25, color=:red)
...
manifest_format = "2.0"
project_hash = "5ed9563b1f97ab2a83a000581ee084fc66522ee4"
